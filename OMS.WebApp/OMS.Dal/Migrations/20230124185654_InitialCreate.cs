        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 7, "Trade Show" },
                    { 8, "Agent" },
                    { 9, "Inbound Lead:Distributor" },
                    { 10, "Inbound Lead:Facebook" },
                    { 11, "Inbound Lead:Google" },
                    { 12, "Dealer - Demo" },
                    { 13, "Parochial School" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Discount 10+boxes", 0.10m },
                    { 2, "Discount Starter Kit E-DaVinci", 0.20m },
                    { 3, "Discount Starter Kit E-Leo", 0.20m },
                    { 4, "Loyalty Discount", 0.05m }
                });
